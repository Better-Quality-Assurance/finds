...
`,
  ...
  {
    slug: 'how-to-import-classic-car-romania',
    category: 'practical-guide',
    tags: ['import', 'romania', 'registration', 'customs'],
    readingTime: 6,
    featuredImage: 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=1200&h=630&fit=crop',
    titleEn: 'How to Import a Classic Car to Romania: Complete Guide 2025',
    titleRo: 'Cum să Imporți o Mașină Clasică în România: Ghid Complet 2025',
    excerptEn: 'Step-by-step guide to importing a classic vehicle to Romania, including customs and registration requirements.',
    excerptRo: 'Ghid pas cu pas pentru importul unui vehicul clasic în România, incluzând proceduri vamale și cerințe de înmatriculare.',
    metaTitleEn: 'Import a Classic Car to Romania | Complete 2025 Guide',
    metaTitleRo: 'Importă o Mașină Clasică în România | Ghid Complet 2025',
    metaDescriptionEn: 'Complete guide to importing classic cars to Romania. Customs, registration, taxes, and documents. Updated for 2025.',
...
<h3>Step 1: Obtain Export Documentation</h3>
<ul>
<li>Deregister the vehicle in the origin country</li>
<li>Obtain certificate of deregistration</li>
<li>Gather service history and documentation</li>
</ul>

<h3>Step 2: Transport to Romania</h3>
<p>No special permits required within EU for driving or trailering.</p>

<h3>Step 3: Romanian Registration (RAR)</h3>
<p>Visit local RAR office with: original documents, deregistration certificate, valid ID, proof of Romanian address, insurance (RCA), and ITP certificate.</p>

<h3>Step 4: ITP (Technical Inspection)</h3>
<p>For vehicles over 30 years old, Romania offers historic vehicle status which may exempt you from certain modern requirements.</p>

<h2>Non-EU Import: Additional Requirements</h2>

<ul>
<li><strong>Import duty:</strong> 10% of declared value</li>
<li><strong>VAT:</strong> 19% calculated on (value + import duty + transport costs)</li>
<li>Customs declaration (DAU) required</li>
</ul>

<h2>Costs Summary</h2>

<table>
<tr><th>Item</th><th>EU Import</th><th>Non-EU Import</th></tr>
<tr><td>Import Duty</td><td>None</td><td>10% of value</td></tr>
<tr><td>VAT</td><td>None</td><td>19%</td></tr>
<tr><td>RAR Registration</td><td>~200-400 RON</td><td>~200-400 RON</td></tr>
<tr><td>ITP Inspection</td><td>~150-300 RON</td><td>~150-300 RON</td></tr>
<tr><td>Number Plates</td><td>~50 RON</td><td>~50 RON</td></tr>
</table>

<h2>Getting Help</h2>

<p>Several customs brokers in Romania specialize in vehicle import. For valuable classics, the €200-500 for professional assistance is worthwhile.</p>

<hr />
<p><em>Finds is an EU-based classic car auction platform built by <a href="https://betterqa.co">BetterQA</a>. We're based in Cluj-Napoca, Romania, and understand the local market firsthand.</em></p>
`,
    contentRo: `
<p>România a devenit o bază atractivă pentru colecționarii de mașini clasice. Costuri mai mici de stocare și acces la descoperiri din hambare o fac practică.</p>

<h2>Import din UE în România</h2>

<ol>
<li>Obține documentația de export și certificat de radiere</li>
<li>Transportă în România (fără permise speciale în UE)</li>
<li>Vizitează RAR cu documentele originale, asigurare RCA, ITP</li>
<li>Obține plăcuțe de înmatriculare</li>
</ol>

<h2>Import din afara UE</h2>
<ul>
<li><strong>Taxă import:</strong> 10% din valoare</li>
<li><strong>TVA:</strong> 19%</li>
<li>Declarație vamală DAU</li>
</ul>

<h2>Costuri</h2>
<p>Înmatriculare RAR: ~200-400 RON | ITP: ~150-300 RON | Plăcuțe: ~50 RON</p>

<hr />
<p><em>Finds are sediul în Cluj-Napoca, construită de <a href="https://betterqa.co">BetterQA</a>.</em></p>
`,
...
<h3>Surface Rust</h3>
<p>Cosmetic only — affects the paint layer and very top of the steel. Easily treated with sanding and proper preparation.</p>

<h3>Scale Rust</h3>
<p>Progressed deeper into the steel. The metal surface is pitted and rough. Can be treated but requires more aggressive intervention.</p>

<h3>Penetrating Rust</h3>
<p>Through the steel. Holes form, structural members weaken. Repair means cutting out and welding in new metal. Expensive.</p>

<h2>Where to Look: The Usual Suspects</h2>

<h3>Sills (Rocker Panels)</h3>
<p>Poke firmly with a screwdriver at the base of the sill. Sound metal resists; rotten metal crumbles. Look for bubbling paint or fresh underseal.</p>

<h3>Wheel Arches</h3>
<p>Feel inside the arch with your hand. Compare both sides — asymmetry suggests repair or ongoing problems.</p>

<h3>Floor Pans</h3>
<p>Lift all carpets and sound deadening. Poke suspected areas. Fresh underseal is a red flag.</p>

<h3>Door Bottoms</h3>
<p>Run your finger along the bottom edge. Feel for roughness or thin spots.</p>

<h3>Boot (Trunk) Floor</h3>
<p>Remove all contents and liners. Check particularly around the edges.</p>

<h2>Red Flags: Signs of Hidden Problems</h2>

<ul>
<li><strong>Fresh underseal:</strong> Often applied to hide problems</li>
<li><strong>Paint bubbling:</strong> Rust pushing from underneath</li>
<li><strong>Misaligned panels:</strong> May indicate rust in structural areas</li>
<li><strong>Evidence of filler:</strong> Use a magnet to check panels</li>
<li><strong>New carpets in old cars:</strong> Why were they replaced?</li>
</ul>

<h2>Pre-Purchase Inspection is Worth It</h2>

<p>For any classic car over €10,000, a professional pre-purchase inspection pays for itself. Expect to pay €200-400, but that's cheap compared to discovering €5,000 of hidden rust after you've bought the car.</p>

<p>On <a href="/">Finds</a>, we encourage sellers to provide detailed photos of known problem areas and disclose previous repairs.</p>

<hr />
<p><em>Finds is built by <a href="https://betterqa.co">BetterQA</a>. We believe in transparency — sellers must disclose known issues.</em></p>
`,
    contentRo: `
<p>Problemele mecanice pot fi reparate. Rugina este cancerul mașinilor clasice. Acest ghid te ajută să identifici problemele înainte să devină ale tale.</p>

<h2>Cele Trei Tipuri de Rugină</h2>
<ul>
<li><strong>Rugină de suprafață:</strong> Doar cosmetică, ușor de tratat</li>
<li><strong>Rugină cu scuame:</strong> Mai adâncă în oțel, necesită intervenție</li>
<li><strong>Rugină penetrantă:</strong> Prin oțel. Reparație costisitoare.</li>
</ul>

<h2>Unde să Cauți</h2>
<ul>
<li><strong>Praguri:</strong> Apasă cu șurubelnița. Metalul sănătos rezistă.</li>
<li><strong>Pasaje roți:</strong> Simte în interior, compară ambele părți.</li>
<li><strong>Podele:</strong> Ridică toate covoarele.</li>
<li><strong>Partea de jos a ușilor:</strong> Simte cu degetul marginea.</li>
</ul>

<h2>Semnale de Alarmă</h2>
<ul>
<li>Underseal proaspăt</li>
<li>Vopsea care face bule</li>
<li>Panouri nealiniate</li>
<li>Chit (verifică cu un magnet)</li>
</ul>

<p>Pe <a href="/">Finds</a>, încurajăm vânzătorii să dezvăluie problemele cunoscute.</p>

<hr />
<p><em>Finds crede în transparență. Construită de <a href="https://betterqa.co">BetterQA</a>.</em></p>
`,
    authorSlug: 'james-park',
    daysAgo: 12,
  },
  {
...
<p><strong>Market Value (standard insurance):</strong> The insurer determines what your car is worth at the time of a claim. For classics, this often dramatically undervalues the car.</p>

<p><strong>Agreed Value (classic insurance):</strong> You and the insurer agree on the car's value when the policy starts, backed by documentation. If the car is totaled, you receive the agreed amount.</p>

<h2>Usage Restrictions</h2>

<p>Classic car insurance typically comes with limitations:</p>

<ul>
<li><strong>Mileage caps:</strong> Typically 3,000-8,000 km/year</li>
<li><strong>Pleasure use only:</strong> Not for daily commuting</li>
<li><strong>Garage storage:</strong> Many policies require overnight garage storage</li>
<li><strong>Secondary vehicle:</strong> Most require you to own a separate daily driver</li>
</ul>

<h2>European Specialist Insurers</h2>

<ul>
<li><strong>Hagerty</strong> (UK, expanding in Europe)</li>
<li><strong>OCC Assekuranz</strong> (Germany)</li>
<li><strong>Zurich Classic Car</strong> (pan-European)</li>
<li><strong>Classic Insurance AG</strong> (Switzerland, Germany)</li>
</ul>

<h2>Common Mistakes</h2>

<ol>
<li><strong>Under-insuring to save premium:</strong> If you agreed on €20,000 but the car is now worth €35,000, you'll receive €20,000 if it's totaled.</li>
<li><strong>Not updating after improvements:</strong> Major restoration should trigger a policy review.</li>
<li><strong>Exceeding mileage limits:</strong> Keep records and contact your insurer if you'll exceed limits.</li>
</ol>

<p>When buying through platforms like <a href="/">Finds</a>, arrange insurance before you bid. Many agreed value policies take 24-48 hours to activate.</p>

<hr />
<p><em>Finds is a classic car auction platform built by <a href="https://betterqa.co">BetterQA</a>.</em></p>
`,
    contentRo: `
<p>BMW-ul tău 2002 din 1972 nu mai valorează 5.000 €. Valorează 25.000 €, și asigurarea standard îți va plăti valoarea de piață pentru o "mașină de 45 de ani" — mult sub investiția ta.</p>

<h2>Valoare Convenită vs. Valoare de Piață</h2>

<p><strong>Valoare de Piață:</strong> Asigurătorul determină valoarea. Subevaluează clasicele.</p>
<p><strong>Valoare Convenită:</strong> Tu și asigurătorul conveniți valoarea la începutul poliței.</p>

<h2>Restricții de Utilizare</h2>
<ul>
<li>Limite de kilometraj: 3.000-8.000 km/an</li>
<li>Doar utilizare recreativă</li>
<li>Stocare în garaj</li>
<li>Vehicul secundar</li>
</ul>

<h2>Asigurători Specializați</h2>
<ul>
<li>Hagerty (UK)</li>
<li>OCC Assekuranz (Germania)</li>
<li>Zurich Classic Car</li>
<li>Classic Insurance AG</li>
</ul>
...
`,
  ...
  {
    slug: 'why-we-built-finds-betterqa-story',
    category: 'company',
    tags: ['betterqa', 'about', 'story', 'platform'],
    readingTime: 5,
    featuredImage: 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=1200&h=630&fit=crop',
    titleEn: 'Why We Built Finds: A BetterQA Story',
    titleRo: 'De Ce Am Construit Finds: O Poveste BetterQA',
    excerptEn: 'How a software quality company in Cluj-Napoca ended up building a classic car auction platform.',
    excerptRo: 'Cum o companie de calitate software din Cluj-Napoca a ajuns să construiască o platformă de licitații.',
    metaTitleEn: 'Why We Built Finds | BetterQA Classic Car Platform',
    metaTitleRo: 'De Ce Am Construit Finds | Platforma BetterQA',
    metaDescriptionEn: 'The story behind Finds: how BetterQA applied quality principles to build a trustworthy classic car auction platform.',
    metaDescriptionRo: 'Povestea din spatele Finds: cum BetterQA a aplicat principii de calitate pentru platformă.',
    contentEn: `
<p><a href="https://betterqa.co">BetterQA</a> is a software testing company. We test banking applications, medical devices, and defense systems. Our engineers find bugs before they reach production, validate that software works as intended, and ensure quality across complex systems.</p>

<p>So why are we building a classic car auction platform?</p>

<h2>It Started with a Dacia 1300</h2>

<p>Several of our engineers are car enthusiasts. Not Bugatti collectors, but people who appreciate a well-maintained Dacia 1300, a project Alfa Romeo, or a barn-find Trabant.</p>

<p>When one of our team tried to buy a classic online, they encountered the same problems repeatedly:</p>

<ul>
<li>Listings that hid problems behind careful photography</li>
<li>Sellers who disappeared when asked for more details</li>
<li>Platforms that took money but offered no protection</li>
<li>No way to verify that cars were actually as described</li>
</ul>

<p>This felt familiar. In software testing, we spend our days asking: "Does this actually work the way it claims to?" The classic car market needed someone asking the same question.</p>

<h2>Quality Principles Applied to Cars</h2>

<h3>Verification Over Trust</h3>
<p>In software testing, we don't assume code works — we verify it. On Finds, we don't assume listings are accurate — we review them. Every listing goes through manual approval.</p>

<h3>Transparency in Process</h3>
<p>Our testing reports tell clients exactly what we found, good and bad. Finds listings must disclose known issues.</p>

<h3>Systematic Approach</h3>
<p>Clear fees (5% buyer premium, no hidden costs), defined processes, and consistent standards bring order that benefits everyone.</p>

<h2>Why Romania, Why Now</h2>

<p>BetterQA is based in Cluj-Napoca, Romania. We see the Eastern European classic car market emerging in ways that Western Europe experienced a decade ago.</p>

<p>Barn finds still happen here. Dacias, Trabants, and AROs sat in garages through the 1990s and 2000s while their Western counterparts were scrapped. Now, enthusiasts worldwide are discovering these cars.</p>

<h2>The BetterQA Connection</h2>

<p>Every BetterQA client gets access to our internal tools — BugBoard for bug tracking, Flows for test automation, BetterFlow for project management. These tools grew from solving our own problems.</p>

<p>Finds is the same philosophy applied to a different domain. We're enthusiasts who happen to know how to build reliable software.</p>

<h2>Come Drive With Us</h2>

<p>If you're looking for your first classic, or your tenth, <a href="/auctions">browse current auctions</a>. If you have a car to sell, <a href="/sell">list with us</a>.</p>

<p>The classic car market should be accessible, transparent, and trustworthy. That's what we're building.</p>

<hr />
<p><em>Finds is a <a href="https://betterqa.co">BetterQA</a> project. BetterQA is a software testing company based in Cluj-Napoca, Romania, serving clients including Samsung, McDonald's, and NATO-certified systems.</em></p>
`,
    contentRo: `
<p><a href="https://betterqa.co">BetterQA</a> este o companie de testare software. Testăm aplicații bancare, dispozitive medicale și sisteme de apărare. De ce construim o platformă de licitații pentru mașini clasice?</p>

<h2>A Început cu o Dacia 1300</h2>

<p>Mai mulți ingineri de-ai noștri sunt entuziaști auto. Când unul a încercat să cumpere o clasică online, a întâmpinat aceleași probleme:</p>

<ul>
<li>Anunțuri care ascundeau probleme</li>
<li>Vânzători care dispăreau</li>
<li>Platforme fără protecție</li>
</ul>

<p>În testare software întrebăm: "Funcționează asta cum pretinde?" Piața mașinilor clasice avea nevoie de aceeași întrebare.</p>

<h2>Principii de Calitate Aplicate la Mașini</h2>

<ul>
<li><strong>Verificare:</strong> Nu presupunem că anunțurile sunt corecte — le verificăm</li>
<li><strong>Transparență:</strong> Anunțurile trebuie să dezvăluie problemele</li>
<li><strong>Abordare sistematică:</strong> Taxe clare (5%), procese definite</li>
</ul>

<h2>De Ce România</h2>

<p>BetterQA are sediul în Cluj-Napoca. Descoperirile din hambare încă se întâmplă aici. Dacii, Trabanți și ARO-uri au stat în garaje în anii 1990 în timp ce omologii occidentali erau casați.</p>

<h2>Vino să Conduci cu Noi</h2>

<p><a href="/auctions">Explorează licitațiile</a>. <a href="/sell">Listează-ți mașina</a>.</p>

<hr />
<p><em>Finds este un proiect <a href="https://betterqa.co">BetterQA</a>. Deservim clienți precum Samsung, McDonald's și sisteme certificate NATO.</em></p>
`,
    authorSlug: 'marcus-webb',
    daysAgo: 30,
  },
